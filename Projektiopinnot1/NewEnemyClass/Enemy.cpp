...
void notifyComponentDestruction(int cid)
{
	for (unsigned int i = 0; i < components.size(); i++)
	{
...
void Enemy::checkBulletCollision(Bullet*)
{
...
void explosion(int dmg, float explosionRadius)
{
	for (unsigned int i = 0; i < mGame->playerObj->components.size(); i++)
	{
